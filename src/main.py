...
model = build_conv_model(ds.input_shape)

# %%
frcstr = Forecaster([mck1_weather_url, mck2_weather_url], mck_vida_url, model)
...
#%%
evaluate_model(frcstr.model, ds.target_scaler, ds.X_test_shaped, ds.y_test)
