...
class Evaluator:
    ...
    @property
    def mape_by_window(self):
        """
        Calculates the mean absolute percentage error for each window size.

        Returns:
            dict[Timedelta, float]: A dictionary with the mean absolute percentage error for each window size.
        """
        mape = {}
    ...
    @property
    def mae_by_window(self):
        """
        Calculates the mean absolute error for each window size.

        Returns:
            dict[Timedelta, float]: A dictionary with the mean absolute error for each window size.
        """
        mae = {}
    ...
    @property
    def absolute_errors_by_window(self):
        """
        Calculates the absolute errors between the y_true and y_pred values for each window size.

        Returns:
            dict[Timedelta, list[float]]: A dictionary with the errors between the y_true and y_pred values for each window size.
        """
        return self.errors_grouped_by_window(absolute=True)

    @property
    def percent_errors_by_window(self):
        """
    ...
    def errors_grouped_by_window(self, absolute=True):
        """
...
def build_evaluator_from_csv(path="data/inference_eval_example.csv"):
    """
