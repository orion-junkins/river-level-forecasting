...
from darts_custom.ensemble_model_custom import EnsembleModelCustom
...
class RegressionEnsembleModelCustom(EnsembleModelCustom):
    def __init__(
        self,
    ...
    def fit(
        ...
        for model, cur_past_covariates in zip(self.models, past_covariates):
            model._fit_wrapper(
                ...
                past_covariates=cur_past_covariates,
        ...
        for model, cur_past_covariates in zip(self.models, past_covariates):
            if self.is_global_ensemble:
                ...
                if model.uses_past_covariates:
                    kwargs["past_covariates"] = cur_past_covariates
